const Impact = () => {
  return (
    <section className="py-16 sm:py-24" id="impact">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="mt-4 text-lg text-text-light-muted dark:text-text-dark-muted max-w-2xl mx-auto">
            Reaching hearts and transforming lives through faith and community.
          </p>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 text-center -mt-5">
        ...
        <div className="mt-9 flex justify-center items-center gap-6 ">
          <p className="text-sm font-semibold text-text-light-muted dark:text-text-dark-muted">
            FIND US ON:
          </p>
          <div className="flex gap-4">
            <a
              className="text-text-light-muted dark:text-text-dark-muted hover:text-primary dark:hover:text-secondary"
